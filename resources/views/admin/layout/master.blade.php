                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow text-dark" href="{{ route('category#List') }}">
                                <i class="fa-solid fa-list"></i> Category List
                            </a>
                        </li>

                        <li class="active has-sub">
                            <a class="js-arrow text-dark" href="{{ route('product#list') }}">
                                <i class="fa-solid fa-leaf"></i> Product List
                            </a>
                        </li>
                        <li class="active has-sub">
                            <a class="js-arrow text-dark" href="{{ route('user#list') }}">
                                <i class="fa-solid fa-users"></i> User List
                            </a>
                        </li>
                        <li class="active has-sub">
                            <a class="js-arrow text-dark" href="{{ route('user#orderList') }}">
